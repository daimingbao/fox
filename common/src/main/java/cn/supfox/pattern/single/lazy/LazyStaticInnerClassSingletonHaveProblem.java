...
/*
  ClassPath : LazyStaticInnerClassSingleton.class
   ...
   缺点：不优雅
 */
public class LazyStaticInnerClassSingletonHaveProblem {

    private LazyStaticInnerClassSingletonHaveProblem(){
...
//        }
    ...
    private static LazyStaticInnerClassSingletonHaveProblem getInstance(){
        return LazyHolder.INSTANCE;
    }

    private static class LazyHolder{
        private static final LazyStaticInnerClassSingletonHaveProblem INSTANCE = new LazyStaticInnerClassSingletonHaveProblem();
    }
