package cn.supfox.pattern.builder.sql;

import cn.supfox.pattern.builder.sql.QueryRule.Rule;
 ...
 * @author Tom
 * Mybatis里也用到了构造者模式<br>
 * Spring中BeanDefinitionBuilder构造BeanDefinition<br>
 *
 */
